...
// =======================================================
//     LÓGICA DA PÁGINA 'monitor.html' (LER TEMPERATURA)
// =======================================================
// **** Usando DOMContentLoaded ****
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (tempDisplay) { // Estamos na página monitor.html
        ...
        // Vamos supor que o ESP32 vai salvar em "sensores/sala_principal/temperatura"
        ...
        tempRef.on('value', (snapshot) => {
            ...
            if (temperatura !== null && !isNaN(temperatura)) {
                ...
                tempDisplay.style.color = "#aaa"; // Cinza
            }
            
        }, (errorObject) => {
            console.error("DEBUG: Erro ao ler temperatura do Firebase:", errorObject.code);
            tempStatus.innerText = "Erro de conexão com o banco de dados.";
        });
    }
});